    ...
    self.thenOpen(usableUri, function() {
        this.waitForSelector('li.entity', function() {
            ...
            var results = this.evaluate(function() {
                ...
                $('.entity').each(function(targetString){
                    var leadInfoSet = {};
            ...
            // reallyINeedThisAray.push(personResults);
            var totalSet = JSON.stringify(personResults, null, '    ');
            var pedigreeEcho = 'No: ' + (index + 1) + ', Name: ' + link.target + ', Company: ' + link.company + ', ID: ' + link.id;

            var jsonFileContents = fs.open('results/json/LI_results_v-0.5.json', 'r');
            ...
            if(index < 1) {
                ...
                fs.write('results/json/LI_results_v-0.5.json', '[\n' + jsonResults, 'a');
                ...
                fs.write('results/json/LI_results_v-0.5.json', ',\n' + jsonResults + '\n]', 'a');
                this.echo(pedigreeEcho + '\nCompleting the file.\nGoodbye.');
            }// if LI_results_v-0.5.json is empty then append a '[', else append a ',' plus the data
